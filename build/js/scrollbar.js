...
function init(){
    ...
    if(visible){
        ...
        scrollbarHeight = scrollbar.getBoundingClientRect().height - 12;     
    } 
}
...
function bodyscrollheigth() {
    return scrollY / (allhight / 100);
}

function setDot() {
    let top = (scrollbarHeight / 100) * bodyscrollheigth();
