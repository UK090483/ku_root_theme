...
<nav id="site-navigation" class="main-navigation <?php echo $kubase_menu_color_class ?>">
    <div class='nav-color-container'></div>
    <div class='container nav-container'>
        ...
        <div class="nav--upper">
            ...
            <div class="nav--mobile-langSwitch">
                <a class="nav--mobile-langSwitch-item" href="">E</a>
                <a class="nav--mobile-langSwitch-item" href="">F</a>
                <a class="nav--mobile-langSwitch-item" href="">D</a>
            </div>
